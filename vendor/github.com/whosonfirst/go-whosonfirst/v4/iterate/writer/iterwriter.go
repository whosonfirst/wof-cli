...
type IterwriterCallback func(context.Context, *iterate.Record, wof_writer.Writer) error

func DefaultIterwriterCallback(forgiving bool) IterwriterCallback {

	return func(ctx context.Context, rec *iterate.Record, wr wof_writer.Writer) error {
